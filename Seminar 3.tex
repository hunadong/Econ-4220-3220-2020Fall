...
Another example:
\begin{itemize}
\item You can also try to derive $p_i(x)$ from the Marshallian demand E.1 on pp. 32 and compare with the result E.5-E.6 on pp. 83, which is derived from Hotelling-Wold identity.
\end{itemize}
