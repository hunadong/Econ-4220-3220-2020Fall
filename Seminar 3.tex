...
%***************************************************
\subsection{Method 2 - Derivative}

Given $p_1x_1 + p_2x_2 = 1$, we can express $p_1$ with $p_2$ as:
$$p_1 = \frac{1 - p_2x_2}{x_1}$$

Substitute $p_1$ and $p_2$ into $v(p,1)$ we get the minimized value, i.e. the direct utility function:
