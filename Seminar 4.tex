...
This review part contains the following key points:

\begin{itemize}
\item The slop of indifference curve is MRS;
\item MRS shows the relative importance of the two commodities;
\item The relationship between $MRS_{12}$ and $\frac{x_2}{x_1}$ shows the substitution relationship between the two commodities;
\item The relationship between $MRS_{12}$ and $\frac{x_2}{x_1}$ can be expressed by Elasticity of Substitution $\sigma_{12}$
...
\subsection{$\alpha$ and $\frac{x_2}{x_1}$}


The relationship between $\alpha$ and $\frac{x_2}{x_1}$ also reflects the nature of the two commodities.
...
\subsection{Elasticity of Substitution $\sigma_{12}$}

We can use "\textbf{Elasticity}" to reflect the relationship between $\alpha$ and $\frac{x_2}{x_1}$.
...
\begin{itemize}
\item Inside brackets: when $\frac{x_2}{x_1}$ changes 1 percent, how many percent $MRTS$ changes. E.g. $0$ if perfect substitution, $+\infty$ if no substitution.
\item Why inverse? We want it to be $+\infty$ when perfect substitution, and $0$ when no substitution.
\end{itemize}




\textbf{DEFINITION: The Elasticity of Substitution} (a 2-input case for DEFINITION 3.2 on Jehle \& Reny pp. 129)
