...
\section*{exam 2019 Q1(c) - Choice with uncertainty}

c) [5\%] Suppose that $x$ and $y$ measure the same commodity in two
...
\section*{exam 2019 Q1(D) - Choice with uncertainty}
...
Calculate $\sigma$ for the Cobb-Douglas production function $y = Ax_1^\alpha x_2^\beta$
